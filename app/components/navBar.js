                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <a href="/" className={`block py-2 pl-3 pr-4 ${pathname === '/' ? 'text-blue-700 md:text-blue-700 md:bg-transparent' : 'text-white md:text-white'} rounded md:p-0`} aria-current="page">Home</a>
                            </li>
                            <li>
                                <a href="/about" className={`block py-2 pl-3 pr-4 ${pathname === '/about' ? 'text-blue-700 md:text-blue-700 md:bg-transparent' : 'text-white'} rounded md:p-0`} >About</a>
                            </li>
                            <li>
